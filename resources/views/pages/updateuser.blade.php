...
@section('mid')
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="{{asset('/')}}">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Update your private data</strong></div>
            </div>
        </div>
    </div>
    ...
    @isset($errors)
        ...
        <br/> <br/>
    @endisset
    <form action="{{route('updatemyacc' , ['id' =>$user->idUser])}}" method="post">
